  ...
  useEffect(() => {
    async function fetchDashboard() {
      try {
        ...
        // Follow-up alerts: customers with no follow_up in last 30 days
        const alerts = all.filter((c) => {
          ...
          // No follow-up at all — check created_at
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link href="/customers/new" className="btn-accent flex items-center gap-2 self-start sm:self-auto">
      ...
      {followUpAlerts.length > 0 && (
        <div className="card border-amber-700/50 bg-amber-900/10">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/follow-ups" className="text-amber-400 hover:text-amber-300 text-sm underline">
              Ver todos
            </Link>
          </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/customers" className="text-blue-400 hover:text-blue-300 text-sm underline">
            Ver todos
          </Link>
        </div>
